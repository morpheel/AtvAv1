...
class AvaliacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avaliacao" do
    assert_difference('Avaliacao.count') do
      post avaliacaos_url, params: { avaliacao: { data: @avaliacao.data, disciplina_id: @avaliacao.disciplina_id, nome: @avaliacao.nome } }
    end
  ...
  test "should update avaliacao" do
    patch avaliacao_url(@avaliacao), params: { avaliacao: { data: @avaliacao.data, disciplina_id: @avaliacao.disciplina_id, nome: @avaliacao.nome } }
