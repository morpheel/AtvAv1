...
class SalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post salas_url, params: { sala: { bloco: @sala.bloco, capacidade: @sala.capacidade, numSala: @sala.numSala } }
    end
  ...
  test "should update sala" do
    patch sala_url(@sala), params: { sala: { bloco: @sala.bloco, capacidade: @sala.capacidade, numSala: @sala.numSala } }
