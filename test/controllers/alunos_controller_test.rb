...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { dt_Nasc: @aluno.dt_Nasc, endereco: @aluno.endereco, nome: @aluno.nome } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { dt_Nasc: @aluno.dt_Nasc, endereco: @aluno.endereco, nome: @aluno.nome } }
